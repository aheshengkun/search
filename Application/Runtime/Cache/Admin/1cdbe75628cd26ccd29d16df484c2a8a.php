...
<form name="form_user" method="post" action="<?php echo U(MODULE_NAME.'/Access/userAdd');?>" onSubmit="return check_form();" autocomplete="off" >
	<tr>
    <td valign="top">
                    ...
                    <tr>
                      <td>
                        <div class="module_border">
                            ...
                            <div class="c">
                            <select name="role_id" class="searchoption"><?php echo ($role["pidOption"]); ?></select>
                            </div>
                        </div>
                      </td>
                    </tr>
