...
<form name="form_user" method="post" action="<?php echo U(MODULE_NAME.'/SearchArticle/addArticle');?>"  autocomplete="off" id="submitForm" enctype="multipart/form-data">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_fm">
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        <input name="title" type="text" class="text"  value="" />
                ...
                <tr>
                  <td><div class="module_border">
                      <div class="l">URL：</div>
                      <div>
                        <input name="url" type="text" class="text"  value="" />
                      </div>
                    </div></td>
                </tr>                 
                <tr>
