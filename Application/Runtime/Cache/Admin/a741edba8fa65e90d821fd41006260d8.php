...
<form name="form_user" method="post" action="<?php echo U(MODULE_NAME.'/Access/nodeEdit');?>" onSubmit="return check_form();" autocomplete="off" >
	<tr>
    <td valign="top">
      <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0">
          <tr>
              <td height="31">
               <div class="titlebt">编辑节点</div>
              </td>
          </tr>
      </table>
    </td>
                    ...
                    <tr>
                      <td>
                        <div class="module_border">
                            <div class="l">名称：</div>
                            <div class="c">
                                <input name="name" type="text" class="input_w" value='<?php echo ($nodeInfo["name"]); ?>'/><font color="#FF0000">*</font>
                            </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="module_border">
                            <div class="l">显示名：</div>
                            <div class="c">
                                <input name="title" type="text"class="input_w" value='<?php echo ($nodeInfo["title"]); ?>'/><font color="#FF0000">*</font>
                            </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="module_border">
                            <div class="l">状态：</div>
                            <div class="c">
                              <?php if($info["status"] == 1): ?><input name="status" type="radio" value="1" checked />开通
                              <input name="status" type="radio" value="0" />关闭
                              <?php else: ?>
                              <input name="status" type="radio" value="1" />开通
                              <input name="status" type="radio" value="0" checked />关闭<?php endif; ?>
                            </div>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <div class="module_border">
                            <div class="l">排序：</div>
                            <div class="c">
                                <input name="sort" type="text"class="input_w" value='<?php echo ($nodeInfo["sort"]); ?>'/><font color="#FF0000">*</font>
                            </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="module_border">
                            <div class="l">描 述：</div>
                            <div class="c">
                                <input name="remark" type="text"class="input_w" value='<?php echo ($nodeInfo["remark"]); ?>'/>
                            </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="module_border">
                          <div class="l">&nbsp;</div>
                          <div class="c">
                        	<input type="hidden" name="nid" value='<?php echo ($nodeInfo["id"]); ?>'/>
