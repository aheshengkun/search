...
<body>
<!--<form name="form_user" method="post" action="<?php echo U(MODULE_NAME.'/ArticleContent/updateArticle');?>" onSubmit="return check_form();" autocomplete="off" >-->
<form name="form_user" method="post" action="<?php echo U(MODULE_NAME.'/ArticleContent/updateArticle');?>" autocomplete="off" id="submitForm" enctype="multipart/form-data">
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="0" class="content_fm">
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        ...
                        <script>
                          $("#pid option[value='<?php echo ($article["post_tid"]); ?>']").attr("selected","selected");
                        </script>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        ...
                        <script>
                          $("#post_type option[value='<?php echo ($article["post_type"]); ?>']").attr("selected","selected");
                        </script>
                      </div>
                    </div></td>
                </tr>
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        ...
                        <img src="/<?php echo ($article["face_img"]); ?>" alt="" id="roleimg" style="margin-top:10px;"><br />
                      </div>
                    </div></td>
                </tr>
                <tr>
                  <td><div class="module_border">
                      ...
                      <div class="c">
                        <label><input name="top" type="radio" value="1" <?php if($article[top] == "1"): ?>checked="checked"<?php endif; ?> /> 置顶</label>&nbsp;&nbsp;
                        <label><input name="top" type="radio" value="0" <?php if($article[top] == "0"): ?>checked="checked"<?php endif; ?> /> 不置顶</label>
                      </div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        <input name="post_title" type="text" class="text"  value="<?php echo ($article["post_title"]); ?>" />
                ...
                <tr>
                  <td><div class="module_border">
                      ...
                      <div>
                        <input name="post_name" type="text" class="text"  value="<?php echo ($article["post_name"]); ?>" />
                      </div>
                    </div></td>
                </tr>
                ...
                <tr>
                  <td><div class="module_border v_center1">
                      ...
                      <div>
                        <textarea name="post_excerpt" class="textarea"><?php echo ($article["post_excerpt"]); ?></textarea>
                      </div>
                    </div></td>
                </tr>
                ...
                <tr>
                  <td><div class="module_border">
                      ...
                      <div class="c">
                        <input name="post_status" class="c_s" type="radio" value="publish" <?php if($article[post_status] == "publish"): ?>checked="checked"<?php endif; ?> /> 发表&nbsp;&nbsp;
                        <input name="post_status" class="c_s" type="radio" value="draft" <?php if($article[post_status] == "draft"): ?>checked="checked"<?php endif; ?> /> 作为草稿
                      </div>
                    </div></td>
                </tr>
                ...
                <tr>
                  <td><div class="module_border">
                      ...
                      <div class="c">
                        <input type="text" name="dotime1" id="dotime1" value="<?php echo (date('Y-m-d H:i:s',$article["post_date"])); ?>" class="input" style="width:180px;" onClick="WdatePicker({skin:'whyGreen',startDate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                      </div>
                    </div></td>
                </tr>
