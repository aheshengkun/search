...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
		    ...
		    '<option value="1">添&nbsp;&nbsp;加</option>',
		    '</select>',
		    '</div>',

		    '<div class="ke-dialog-row">',
		    '<label style="width:60px;">缩放图片</label>',
		    '<select name="wid">',
		    '<option value="0">不缩放</option>',
		    '<option value="700">宽700px</option>',
		    '<option value="720">宽720px</option>',
		    '<option value="740">宽740px</option>',
		    '<option value="760">宽760px</option>',
		    '<option value="800">宽800px</option>',
		    '<option value="820">宽820px</option>',
		    '<option value="860">宽860px</option>',
		    '<option value="900">宽900px</option>',
		    '<option value="960">宽960px</option>',
		    '<option value="1000">宽1000px</option>',
		    '</select>',
		    '</div>',
