...
;(function($) {
	...
	$.extend(Util.Dialog, {
		...
		create: function(o) {
			...
			boxDom += "</div><div class=\"ui_move_temp\" id=\"" + o.boxID + "_move_temp\"></div><div class=\"ui_overlay\"><iframe src=\"about:blank\" style=\"width:100%;height:" + $(document).height() + "px;filter:alpha(opacity=50);opacity:-1;scrolling=no;border:none;z-index:870611;\"></iframe></div></div>";
